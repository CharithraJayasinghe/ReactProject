            ...
            <div className="card">
                ...
                <div className="card-body">
                    <div className="divbtn">
                        <Link to="employee/create" className="btn btn-success" class="btn1 pbtn">Add New Employee</Link>
                    </div>
                    <div className="divbtn">
                        <Link to="/Department" className="btn btn-success" class="btn1 pbtn1">View Departments</Link>
                    </div>
                    <table className="table table-bordered" bgcolor='#899AE1'>
